...
func _preprocess_entry(_entry: Dictionary) -> void:
	pass
...
func _additional_validate(_entry: Dictionary, _property: String) -> String:
	return ""
...
func _reserve_validate(_entry: Dictionary, _property: String) -> bool:
	return false

## Virtual. Called for every entry after it is processed.
func _postprocess_entry(_entry: Dictionary) -> void:
	pass
